...
namespace Lab2Dawid.Controllers
{
    ...
    {
        private readonly Lab2DawidContext _context;

        public HotelsApiController(Lab2DawidContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Hotel>> PostHotel(Hotel hotel)
        {
          if (_context.Hotel == null)
          {
              return Problem("Entity set 'Lab5_HotelContext.Hotel'  is null.");
          }
